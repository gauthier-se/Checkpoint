 ...
 *   <li><strong>API chain</strong> ({@code /api/v1/**}): stateless JWT authentication.
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http,
        ...
        HttpSecurity chain = http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/plays/*").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/users/*/compare").authenticated()
