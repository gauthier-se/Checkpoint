...
public class WishlistController {
    ...
    /**
     * Sets or clears the priority of a game in the authenticated user's wishlist.
     *
     * @param userDetails the authenticated user principal
     * @param videoGameId the video game ID
     * @param request     the priority update payload (priority may be {@code null} to clear)
     * @return the updated wish entry with 200 status
     */
    @PatchMapping("/{videoGameId}/priority")
    public ResponseEntity<WishResponseDto> updatePriority(
            @AuthenticationPrincipal UserDetails userDetails,
            @PathVariable UUID videoGameId,
